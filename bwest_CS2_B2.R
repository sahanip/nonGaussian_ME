...
data = readMat("trainresults_CS2_B2_forR.mat")  

alldata_tr = data$alldata
nres = 1;
ncov = 3; #Max no. of covariates, for 2 to 8 vars.
...
writeMat("bwresults_CS2_B2.mat", bw = bw, bwm = bwm, datatrain = datatrain, covindex = covindex)
