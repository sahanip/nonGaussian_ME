%compute data for ACF for case study 1, propoosed method 
...
for i = 2:simlength-1
    ...
    for p = 1:novars       
        ...
        temperrest = sampleCKDE(datatrain(:,[fixedres,covindex(fixedres,1:size(covindex,2))]), repmat(bw(fixedres,:), size(datatrain,1),1), n, covindex, covaltemp, 0,0);
...
%save results:
save('ACFdata_CS1_PM.mat', 'xtest', 'eysample', 'x_truefull') 
