...
#This script uses the np package to determine the conditional density bandwidths by Max likelihood cross validation for Case study 1, method b2
...
data = readMat("trainresults_CS1_B2_forR.mat")  

alldata_tr = data$alldata
nres = 1;
ncov = 2; #Max no. of covariates, for 2 to 8 vars.
...
writeMat("bwresults_CS1_B2.mat", bw = bw, bwm = bwm, datatrain = datatrain, covindex = covindex)
