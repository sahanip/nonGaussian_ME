...
%TUNING PARAMETERS:
%INFLATION:
lambda1 = 2;   %this is equivalent to delta1 
...
bmvec = nanmean(driftall,2);
Pmmat = nancov(driftall');

save(['trainresults_CS2_B1_lambda=', num2str(lambda1), '.mat'], 'bmvec', 'Pmmat', 'driftall', 'xt1all')
