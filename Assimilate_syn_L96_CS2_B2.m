...
load bwresults_CS2_B2.mat

%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
plotfigs = 0;  % plot if 1, don't plot if 0
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX

nbins = 10;  %for purposes of sampling errors. 

for ml = 1:noICs
    
    clearvars -except ml nbins simlength maxleadtime *_ar bw bwm covindex datatrain plotfigs tstep K Fcons hx hy obsfreq *_full LSall CRPSall RMSEall ENSVARall ENSMEANERRall noICs obserrvar BINPOSall nobins
    ...
    %XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
    %state variable bounds for - FOLLOWING WILL CHANGE DEPENDING ON THE PROBLEM
    xlb = -20; xub = 20;
    ...
    prodprobthresh = 10^-8;
    multcovvec = NaN*ones(K, simlength);
...
save('assimilateresults_CS2_B2.mat')
