...
decorrtimestep = 20;  %in terms of no. of obs, no. of obs timesteps needed for autocorr to drop to zero.  This can only be known once a full model run is complete...
...
clear x_simonestep x_simonetemp x_obsall y1temp z1temp x1temp x_sim h1 h2 errx_trueall sgtend x_trueall y_trueall err_obs2 errx_true2 covs_true2 t_train x1temp  y0_true Y0tmp X0tmp y_true err_obs obstimeind
save('traininputdata_syn_L96_CS1.mat')
%XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Create data for evaluation period:
